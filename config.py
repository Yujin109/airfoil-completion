...
# EXECUTION_NAME = "250426-001:CFG(all-zero)+pos-enc+beta_end0.05" # OK
# MODEL_NAME = "NewBaseConditionalUNet_CFG_zero"

# EXECUTION_NAME = "250424-002:CFG(all-zero-false)+pos-enc+cos-schedule"  # OK
# MODEL_NAME = "NewBaseConditionalUNet"

# EXECUTION_NAME = "250416-001:Baseline"  # OK
# MODEL_NAME = "BaselineConditionalUNet"

# EXECUTION_NAME = "250424-001:CFG(all-zero-false)+pos-enc+beta_end0.05"  # OK
# MODEL_NAME = "NewBaseConditionalUNet"

# EXECUTION_NAME = "250418-001:CFG(all-zero)"  # OK
# MODEL_NAME = "BaselineConditionalUNet_CFG_zero"

# EXECUTION_NAME = "250418-002:CFG(none)" # OK
# MODEL_NAME = "BaselineConditionalUNet_CFG_none"

# EXECUTION_NAME = "250422-001:ResidualUnet+CFG(none)"  # OK
# MODEL_NAME = "BaselineResUNet_2layer_CFG_none"

# EXECUTION_NAME = "250422-002:CFG(all-zero-false)+pos-enc"  # OK
# MODEL_NAME = "NewBaseConditionalUNet"

EXECUTION_NAME = "250423-001:ResUnet(3-layer)+CFG(none)"
MODEL_NAME = "BaselineResUNet_3layer_CFG_none"

# EXECUTION_NAME = "250425-001:ResUnet(3-layer)+CFG(all-zero-false)+pos-enc+beta_end0.05" # resultなし
# MODEL_NAME = "NewBaseResUNet_3layer"

# EXECUTION_NAME = "250430-001:CFG(none)+pos-enc+beta_end0.05"
# MODEL_NAME = "NewBaseConditionalUNet_CFG_none"

# EXECUTION_NAME = "250419-001:CFG(none)+timestep1000+epoch5000"
# MODEL_NAME = "BaselineConditionalUNet_CFG_none"

# EXECUTION_NAME = "250418-003:CFG(none)+timestep1000"
# MODEL_NAME = "BaselineConditionalUNet_CFG_none"
...
DIFFUSION_PARAMS = {
    ...
    "cosine_s": 0.0,  # 0.008 for cosine schedule
}
